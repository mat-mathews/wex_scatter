...
| `--output-format FORMAT` | `console` | Output format: `console`, `csv`, `json`, `markdown` |
| `--output-file PATH` | — | Output file path (required for csv/json; optional for markdown — prints to stdout if omitted) |
...
- **Reporting & Extraction Planning** — Unified report data model, diff reports, baselines, HTML reports
