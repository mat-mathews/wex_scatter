    ...
    def test_extracts_unique_sorted(self):
        results = [
            ConsumerResult(
                ...
                target_project_path="T.csproj",
                triggering_type="C",
                consumer_project_name="A",
                consumer_project_path="A.csproj",
            ...
            ConsumerResult(
                ...
                target_project_path="T.csproj",
                triggering_type="C",
                consumer_project_name="B",
                consumer_project_path="B.csproj",
                pipeline_name="deploy-web",
            ),
            ConsumerResult(
                target_project_name="T",
                target_project_path="T.csproj",
                ...
                consumer_project_path="C.csproj",
                pipeline_name="deploy-api",
            ),
        ]
