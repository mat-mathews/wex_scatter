...
from scatter.reports.json_reporter import prepare_detailed_results, write_json_report, write_impact_json_report
...
class TestMetadata:
    ...
    def test_impact_json_includes_metadata(self, tmp_path):
        ...
        assert set(data['metadata'].keys()) == {
            'scatter_version', 'timestamp', 'cli_args', 'search_scope', 'duration_seconds',
        }
